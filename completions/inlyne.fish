...
function __fish_inlyne_global_optspecs
	string join \n t/theme= d/decorations= s/scale= c/config= w/page-width= p/win-pos= win-size= font-size= line-height= h/help V/version
end
...
complete -c inlyne -n "__fish_inlyne_needs_command" -l font-size -d 'Font size [default: 16]' -r
complete -c inlyne -n "__fish_inlyne_needs_command" -l line-height -d 'Line height [default: 1.1]' -r
...
complete -c inlyne -n "__fish_inlyne_using_subcommand view" -l font-size -d 'Font size [default: 16]' -r
complete -c inlyne -n "__fish_inlyne_using_subcommand view" -l line-height -d 'Line height [default: 1.1]' -r
